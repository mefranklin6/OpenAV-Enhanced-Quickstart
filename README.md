...
You'll have a fully functional system up and running with a local Docker Registry that can be used for running unofficial or in-development device microservices.  This is useful for running full test rooms or for development outside of Dartmouth.
